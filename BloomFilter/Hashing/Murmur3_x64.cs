...
namespace BloomFilter.Hashing
{
    public struct Murmur3_x64
    {
        ...
        public ulong HashUpperBound { get { return this._h1; } }
        public ulong HashLowerBound { get { return this._h2; } }

        public Murmur3_x64(uint seed)
        {
			_h2 = 0;
			_h1 = 0;
			_length = 0;
        ...
        public byte[] Hash
        {
            get
            {
                ...
                _h1 = Murmur3_x64.MixFinal(_h1);
                _h2 = Murmur3_x64.MixFinal(_h2);

                _h1 += _h2;
                _h2 += _h1;

                var hash = new byte[Murmur3_x64.ReadSize];
